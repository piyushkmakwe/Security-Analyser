...
CONTROLS: List[Control] = [
    ...
    Control("isolation", "Cross-origin isolation headers", "Security headers", 3,
            "COOP/CORP and related isolation headers are set.",
            _prefix("HDR-ISOLATION")),
    Control("methods", "HTTP methods", "Security headers", 4,
            "No dangerous HTTP methods are enabled.", _exact("HDR-METHODS")),
    Control("csrf", "CSRF protection", "Cookies", 4,
            "State-changing forms carry anti-CSRF tokens.", _exact("FORM-CSRF")),
